package org.cresplanex.api.event.plancommandservice.specification;
...
public class TaskAttachmentSpecifications {
    ...
    public static Specification<org.cresplanex.api.event.plancommandservice.entity.TaskAttachmentEntity> fetchTask() {
